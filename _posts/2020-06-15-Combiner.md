...
I tried using splines at first to connect all the points up and get some estimate of the cable lengths but due to thecurves it was quite a bit over what was requried in the end.
...
<embed src="{{ site.url }}{{ site.baseurl }}/project files/Combiner/Combiner Assembly.pdf" type="application/pdf" width='800' height='600'>
