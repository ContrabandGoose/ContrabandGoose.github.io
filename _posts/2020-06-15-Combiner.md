...
<embed allowfullscreen='true' src="{{ site.url }}{{ site.baseurl }}/project files/Combiner/Combiner Aseembly.pdf" type="application/pdf" width='1000px' height='1000px'>

<div id="Combiner" style="width: 100%; height: 100%"></div>

<script src="/assets/js/pdfobject.js"></script>
<script>PDFObject.embed("/project files/Combiner/Combiner Aseembly.pdf", "#Combiner");</script>
