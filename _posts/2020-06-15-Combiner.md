...
<html>
  <iframe scrolling='no' frameborder='0' allowfullscreen='true' src='{{ site.url }}{{ site.baseurl }}/project files/Combiner/Combiner Assembly.pdf' type="application/pdf"</iframe>
 </html>
